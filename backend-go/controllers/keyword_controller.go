...
func NewKeywordController(kewrordService interfaces.KeywordService) KeywordController {
	return KeywordController{
		KeywordService: kewrordService,
	}
}
...
func (kc *KeywordController) UpdateMovie(ctx *gin.Context) {
	var keyword models.Keyword
...
func (kc *KeywordController) RegisterKeywordRoute(rg *gin.RouterGroup) {
	...
	keywordRoute.PATCH("/update", kc.UpdateMovie)
